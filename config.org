#+TITLE: FG's GNU Emacs Config
#+AUTHOR: Floyd Gantt (FG)
#+DESCRIPTION: FG's personal Emacs config.
...
- [[#backup][BACKUP]]
- [[#common-lisp-development][COMMON LISP DEVELOPMENT]]
  - [[#sbcl][sbcl]]
  - [[#slime][Slime]]
- [[#company][COMPANY]]
- [[#dashboard][DASHBOARD]]
...
#+begin_src emacs-lisp
  (use-package dashboard
    ...
    (setq dashboard-banner-logo-title "Floyd's Dashboard!")
    ;;(setq dashboard-startup-banner 'logo) ;; use standard emacs logo as banner
    (setq dashboard-startup-banner "/Users/fgantt/.config/emacs/images/gnu_banner.jpg")  ;; use custom image as banner
...
;; (global-display-line-numbers-mode nil) ;; Display line numbers
  ...
  (setq elfeed-search-feed-face ":foreground #ffffff :weight bold"
        elfeed-feeds (quote
                       (("https://www.reddit.com/r/linux.rss" reddit linux)
                        ...
                        ("https://planet.lisp.org/rss20.xml" planetlisp lisp)))))
...
#+begin_src emacs-lisp
  ...
  (use-package general
    ...
    (general-create-definer fg/leader-keys
...
;; Enable Paredit while interactively evaluating Emacs Lisp expressions in inferior-emacs-lisp-mode (IELM)
...
;; When we type backspace or delete to delete a parenthesis in the SLIME REPL, Paredit fails to keep the parentheses balanced because SLIME interferes with Paredit by grabbing the delete key. To fix this issue, use the following code
...
;; Enable Rainbow Delimiters while interactively evaluating Emacs Lisp expressions in inferior-emacs-lisp-mode (IELM)
